...
namespace RabbitMQMachineStateConsumer
{
		...
		private void Connect()
		{
			...
			if (_connectionFactory != null)
			{
				...
				if (_connection != null)
				{
						...
						_channelMachineStateConsumer.QueueDeclare("MACHINES_STATELOG", exclusive: false, durable: true, autoDelete: false);
						_channelMachineStateConsumer.BasicQos(prefetchSize: 0, prefetchCount: 1, global: false);
						_channelMachineStateConsumer.QueueBind("MACHINES_STATELOG", "machinesstate", "MACHINE_STATE.LOG");
						...
						consumerMachineStateTag = _channelMachineStateConsumer.BasicConsume("MACHINES_STATELOG", false, consumer);
